...
namespace AdminApi.Controllers
{
    ...
    public class OrganizationsController : ApiController
    {
        ...
        [HttpPatch("updateActiveOrDeactive")]
        public async Task<IActionResult> UpdateOrganizationActiveOrDeActive(UpdateOrganizationActiveOrDeActiveCommand activeOrDeActiveCommand)=>
            Ok(await Mediator.Send(activeOrDeActiveCommand));
